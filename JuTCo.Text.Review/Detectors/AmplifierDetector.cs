...
internal class AmplifierDetector : IDetector
{
    ...
    private const string _description =
        "Такими словами пытаются усилить оценку. Но сами по себе без доказательств, не убеждает читателя. Подкрепите текст доказательствами, чтобы оценка и усилитель не были голословными";

    private const string _shortDescription =
        "Попытка усиления оценки, без доказательств - не убедит читателя";
